...
public class ColumnsRepositoryImpl  implements ColumnsRepository {
	...
	public List<ColumnsTable> findByTableName(String tableName) {
		return jdbcTemplate.query("select * from columns where table_name = ? order by ordinal_position asc", new Object[] { tableName },
